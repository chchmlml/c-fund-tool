...
# Database: cfundtool
# Generation Time: 2020-09-28 06:50:49 +0000
# ************************************************************
...
(
    ...
    `total_out`    double           NOT NULL DEFAULT '0.01' COMMENT '投资总额',
    `total_income` double           NOT NULL DEFAULT '0.01' COMMENT '总收益',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='账户收益表';
...
(
    ...
    `build_date` date             NOT NULL DEFAULT '2020-01-01' COMMENT '成立时间',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT ='基金表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='基金股票关联表';
